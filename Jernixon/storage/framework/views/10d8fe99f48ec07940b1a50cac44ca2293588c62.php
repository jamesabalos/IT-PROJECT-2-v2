<?php $__env->startSection('returns_link'); ?>
class="active"
...
<script>
    ...
    function addReturnItem(ORNumber){
        ...
        var thatTbody = $("#returnItemTbody tr td:first-child");
         ...
         $.ajax({
            method: 'get',
            url: "<?php echo e(route('admin.getORNumberItems')); ?>",
            data:{
                 'ORNumber': ORNumber,
            },        
	...
	function getItems(button){
		...
		$.ajax({
			type:'GET',
			url: "<?php echo e(route('admin.getReturnedItems')); ?>",
            data: {
                'ORNumber': ORnumber,
                'Date': date
            },
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('#returnsDataTable').DataTable({
                    ...
                    "ajax":  {
                                "url": "<?php echo e(route('returns.createReturnsFilter')); ?>",
                                "data":{
    ...
    $(document).ready(function(){
        ...
        $('#formReturnItem').on('submit',function(e){
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('admin.createReturnItem')); ?>",
                // data:{
         ...
         $('#returnsDataTable').DataTable({
            ...
            //   ],
              ...
              "ajax":  "<?php echo e(route('returns.getReturns')); ?>",
              "columns": [
                  {data: 'or_number'},
                //   {data: 'price'},
                  {data: 'created_at'},
...
<div id="return" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="viewLabel" aria-hidden="true"> 
    <div class = "modal-dialog modal-md">
        <div class = "modal-content">
            ...
            <?php echo Form::open(['method'=>'post','id'=>'formReturnItem']); ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">                                
                            <div class="row">
                                <div class="col-md-3">
                                    <?php echo e(Form::label('Official Receipt No:')); ?>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <?php echo e(Form::date('Date','',['class'=>'form-control','id' =>'today','value'=>''])); ?>
                        ...
                        <div class="form-group">    
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <?php echo e(Form::text('Customer','',['class'=>'form-control','value'=>'','disabled'])); ?>
