			...
			<div class="wrap-login100">
                <form class="login100-form validate-form" method="POST" action="<?php echo e(route('admin.login.submit')); ?>">
					...
					<div class="wrap-input100" >
                        <input id="email" class="input100" type="email" name="email" placeholder="Email" value="<?php echo e(old('email')); ?>" required autofocus>
                    ...
                    <a class="txt1" href="/">
                        ...
                        <a class="txt1" href="<?php echo e(route('admin.showForgotPassword')); ?>">
							Forgot Password?
						</a>
					</div>
				</form>
