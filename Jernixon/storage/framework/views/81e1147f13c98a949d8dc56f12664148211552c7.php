<?php $__env->startSection('sales_link'); ?>
class="active"
<?php $__env->stopSection(); ?>



<?php $__env->startSection('ng-app'); ?>
...
<script src="<?php echo e(asset('assets/js/angular-datatables.min.js')); ?>"></script> 
<style type="text/css">
    @media  print{
        /* @page{            
            size: 8.5in 11in; 
            ...
            $(document).ready(function(){
                ...
                $('#formSales').on('submit',function(e){
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo e(route('salesAssistant.createSales')); ?>",
//                        dataType:'json',
                ...
                <div class="col-md-12" >
                    <div class="card" >
                        <div class="header"  id="printArea">
                            <?php echo Form::open(['method'=>'post','id'=>'formSales']); ?>                                
                            <h4 ng-bind="name">Customer Purchase</h4>
                            <div class="row">
                                <div class="col-md-3" >                        
                                        <?php echo e(Form::label('receiptNumber', 'Receipt Number:')); ?>

                                        <?php echo e(Form::number('receiptNumber','',['class'=>'form-control'])); ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-7" margin >
                                        <?php echo e(Form::label('customerName', 'Customer Name:')); ?>

                                        <?php echo e(Form::text('customerName','',['class'=>'form-control'])); ?>
...
//         <?php if(Auth::guard('adminGuard')->check()): ?>
//         "ajax":  "<?php echo e(route('dashboard.getItems')); ?>",
//         <?php elseif(Auth::guard('web')->check()): ?>
//         "ajax":  "<?php echo e(route('SADashboard.getItems')); ?>",
//         <?php endif; ?>
...
// "processing": true,
// "serverSide": true,
"ajax":  "<?php echo e(route('salesAssistant.getItemsSales')); ?>",
// data: [{
//     "LastName": "Doe",
